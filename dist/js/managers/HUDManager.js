...
export class HUDManager {
    ...
    updatePauseScreen(player, enemies) {
        ...
        uniqueProblems.forEach(monster => {
            ...
            if (this.scene.anims.exists(idleKey))
                ...
                sprite.play(monster.getIdleAnimKey());
    ...
    selectItem(player) {
        ...
        if (this.cursorIndex.y < 2) {
            ...
            // Item
            if (idx < ITEM_CONFIG.names.length)
                player.currentItem = ITEM_CONFIG.names[idx];
        }
